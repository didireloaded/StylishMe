...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-CrRnlGYK.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"54f156d0de10": async () => {
		const m = await import("./assets/AppEntry-DdRCbkDt.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"57efa4d50aaa": async () => {
		const m = await import("./assets/PwaRegistration-DdYFVUWk.js");
		return { get "PwaRegistration"() {
			return m["PwaRegistration"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-DwsjEWGl.js");
		return {
			get "ErrorBoundary"() {
	...
	"abe3ff36b97a": async () => {
		const m = await import("./assets/DemoExperience-CzY2bn1C.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"ec4e6800f3c7": async () => {
		const m = await import("./assets/SessionResetGate-CrryaIN2.js");
		return { get "default"() {
			return m["default"];
		} };
	}
