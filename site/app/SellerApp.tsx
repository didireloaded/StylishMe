...
export default function SellerApp({
  ...
  else if (view === "settings") content = <>{header("Settings")}<section className="page-intro"><small>STORE OPERATIONS</small><h1>Settings</h1><p>Account security remains managed through your signed-in account. Store details and inventory are private to this seller.</p></section><section className="form-card"><h2>Low-stock preference</h2><p>Products with fewer than 3 available units are highlighted. More operational controls will appear when their backend services exist.</p></section>{!demoMode && <StoreClosureControl storeName={state.store.name} />}</>;
