...
export default function SellerApp({
  ...
  else if (view === "payouts") content = <>{header("Payouts")}<section className="page-intro"><small>YOUR EARNINGS</small><h1>Payouts</h1><p>Payment provider is not connected, so pending balance, commission, paid sales and payout dates are unavailable.</p></section><section className="seller-empty large"><strong>No payout records</strong><small>Financial figures will appear only after verified payments, commission rules, refunds and settlements are connected.</small></section></>;
